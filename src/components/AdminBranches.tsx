...
import { Plus, Edit, Save, X, MapPin, Phone, Navigation, DollarSign, ChevronDown, ChevronUp, Power, PowerOff, AlertCircle } from 'lucide-react';
...
export const AdminBranches: React.FC<AdminBranchesProps> = ({ onBranchesChange }) => {
  ...
  const { canManageBranches, loading: permissionLoading } = usePermission();
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center bg-red-50 border-2 border-red-200 rounded-lg p-8">
          ...
          <p className="text-red-600">ليس لديك صلاحية لإدارة الفروع. يرجى التواصل مع المسؤول.</p>
        </div>
      </div>
    );
  }
