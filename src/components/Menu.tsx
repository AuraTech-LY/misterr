...
export const MenuItem: React.FC<MenuItemProps> = ({ item, onAddToCart, isMisterCrispy = false }) => {
  ...
  const primaryColorClass = isMisterCrispy ? 'bg-[#781220]' : 'bg-blue-600';
  const primaryColorHoverClass = isMisterCrispy ? 'hover:bg-[#5c0d18]' : 'hover:bg-blue-700';
  const primaryColorTextClass = isMisterCrispy ? 'text-[#781220]' : 'text-blue-600';
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={() => handleQuantityChange(quantity + 1)}
                    className={`w-10 h-10 ${primaryColorClass} ${primaryColorHoverClass.replace('bg-', 'hover:bg-')} text-white rounded-full flex items-center justify-center transition-colors`}
                  >
