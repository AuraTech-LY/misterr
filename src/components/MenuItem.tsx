    ...
    <>
      ...
      >
        ...
        <div className="flex items-center p-4 gap-4 h-32 min-w-0">
          {/* Price Section - Left */}
          <div className="flex flex-col items-center justify-center min-w-[70px] flex-shrink-0 mr-6">
          ...
          <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
            <div className="flex items-start justify-between mb-1">
              <h3 className="text-xs font-bold text-gray-800 truncate flex-1 min-w-0">{item.name}</h3>
              {item.popular && (
