  ...
  return (
    <>
      ...
      <div className={`${isCartOpen ? 'fixed' : 'sticky'} top-0 z-40 w-full`}>
        {/* Placeholder space when navigation is fixed to prevent layout shift */}
        {isCartOpen && (
          <div className="px-3 sm:px-4 py-3 sm:py-4 lg:px-16 xl:px-32 2xl:px-48 w-full invisible">
            <div className="container mx-auto">
              <div className="text-white rounded-2xl sm:rounded-3xl shadow-2xl backdrop-blur-lg border border-white border-opacity-10 px-4 sm:px-6 py-3 sm:py-4 bg-[#781220]">
