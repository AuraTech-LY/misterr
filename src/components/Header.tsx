...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <>
      ...
      {showBackButton && (
        <div className="bg-gray-50 px-3 sm:px-4 py-2 lg:px-16 xl:px-32 2xl:px-48 pt-16 sm:pt-2">
      ...
      {/* Main Navigation Bar */}
      <div className="fixed top-0 left-0 right-0 z-40 px-3 sm:px-4 py-3 sm:py-4 lg:px-16 xl:px-32 2xl:px-48">
      <div className="container mx-auto">
