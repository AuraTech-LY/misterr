  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-40 w-full">
        ...
        <div className="px-3 sm:px-4 py-3 sm:py-4 lg:px-16 xl:px-32 2xl:px-48 invisible">
          <div className="container mx-auto">
        ...
        <div className={`absolute top-0 left-0 right-0 px-3 sm:px-4 py-3 sm:py-4 lg:px-16 xl:px-32 2xl:px-48 w-full transition-all duration-500 ease-in-out transform ${
